...
- `mapName` is one of the maps of the XDP program and is used to determine if a map has already been pinned and needs to be deleted before loading the program.
...
```
 /* Attempt to detach a current program on that interface */
